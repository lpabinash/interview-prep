    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12 py-8 sm:py-10 md:py-16">
      ...
      <header className="mb-14">
        ...
        <p className="font-body text-lg md:text-xl leading-relaxed max-w-2xl">
          10 topics covering warm-up problems, arrays, recursion, sorting,
          linked lists, strings, stacks, queues, binary search, two-pointer
          techniques and trees.
        </p>
      </header>
