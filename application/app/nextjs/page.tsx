...
export default function NextjsHome() {
  const seasons = getNextjsSeasons()
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12 py-8 sm:py-10 md:py-16">
      ...
      <header className="mb-14">
        ...
        <p className="font-body text-lg md:text-xl leading-relaxed max-w-2xl">
          12 chapters covering Next.js App Router from scratch. From routing and
          layouts to data fetching, Server Actions, caching, streaming, and
