    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12 py-8 sm:py-10 md:py-16">
      ...
      <header className="mb-14">
        ...
        <p className="font-body text-lg md:text-xl leading-relaxed max-w-2xl">
          12 chapters covering TypeScript from basics to advanced. From type
          system fundamentals, generics, and utility types to advanced patterns,
          DOM integration, and production configuration.
        </p>
      </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            {season.chapters.map((ch) => (
              <div key={ch.slug} className="relative">
                ...
                <Link
                  href={`/typescript/chapters/${ch.slug}`}
