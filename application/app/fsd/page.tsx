...
export default function FsdHome() {
  const seasons = getFsdSeasons()
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12 py-8 sm:py-10 md:py-16">
      ...
      <header className="mb-14">
        ...
        <p className="font-body text-lg md:text-xl leading-relaxed max-w-2xl">
          Frontend System Design — Security, Networking, Accessibility,
          Performance, Testing, Communication Techniques, Databases & Caching,
          plus High-Level and Low-Level Design patterns.
        </p>
      </header>
